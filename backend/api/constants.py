...
MODEL_GEMINI_PRO_3 = "gemini-3-pro-preview"
...
MODEL_TO_PROVIDER = {
    ...
    MODEL_GEMINI_PRO_3: PROVIDER_GOOGLE,
...
ALL_MODELS = [MODEL_GROK_4, MODEL_GPT_5, MODEL_GEMINI_PRO, MODEL_GEMINI_PRO_3, MODEL_GEMINI_FLASH, MODEL_GEMINI_LEGACY]

# Default when LLM_MODEL env var is not set
DEFAULT_MODEL = MODEL_GROK_4

# ---- Model → API key env var mapping ----
MODEL_API_KEY_MAP = {
    MODEL_GROK_4: "GROK_API_KEY",
    MODEL_GPT_5: "CHATGPT_API_KEY",
    MODEL_GEMINI_PRO: "GEMINI_API_KEY",
    MODEL_GEMINI_PRO_3: "GEMINI_API_KEY",
    MODEL_GEMINI_FLASH: "GEMINI_API_KEY",
    MODEL_GEMINI_LEGACY: "GEMINI_API_KEY",
}
...
FALLBACK_CHAIN = {
    ...
    MODEL_GEMINI_PRO_3: [MODEL_GPT_5, MODEL_GEMINI_FLASH, MODEL_GROK_4],
...
MODELS_WITH_INTERNAL_TOOL_HANDLING = {MODEL_GPT_5, MODEL_GEMINI_PRO, MODEL_GEMINI_PRO_3, MODEL_GEMINI_FLASH, MODEL_GEMINI_LEGACY}
...
MODEL_DISPLAY_NAMES = {
    ...
    MODEL_GEMINI_PRO_3: "Gemini 3 Pro",
